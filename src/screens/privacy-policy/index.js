      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.textContent}>
          ...
          <Text style={styles.paragraph}>
            ...
            data from a minor, please let us know— we’ll remove it without
            delay.
          </Text>
          ...
          <Text style={styles.last}>
            ARM-SBC L.L.C-FZ, Meydan Freezone, 5842+632,{"n"} Grand stand - NAD
            AL SHEBA, Dubai,{"n"} United Arab Emirates
          </Text>
        </View>
      </ScrollView>
    </View>
